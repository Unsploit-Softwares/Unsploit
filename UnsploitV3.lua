-- A modified ui library from Venyx and Kraken Hub
-- Unsploit is ^
...
do
	...
	function library.new(title, gameTitle)
				...
				utility:Create("Frame", {
					...
					utility:Create ("Frame", {
						...
						utility:Create("TextLabel", {
							...
							BackgroundTransparency = 1.000,
							BorderSizePixel = 0,
							Position = UDim2.new(0.0529999994, 0, 0.284999996, 6),
							Size = UDim2.new(0, 132, 0, 33),
		...
		if (#container.Main.SideBar.MenuInfo.Title.Text >= 14) then
			container.Main.SideBar.MenuInfo.Title.TextScaled = true
		end
		...
		return setmetatable({
			container = container,
			pagesContainer = container.Main.SideBar.Pages,
			pages = {}
		}, library)
	end
	...
	function page.new(library, title, icon)
		...
		local container = utility:Create("ScrollingFrame", {
			...
			BackgroundTransparency = 1,
			BorderSizePixel = 0,
			Position = UDim2.new(0.26, 0, 0.012, 0),
			Size = UDim2.new(1, -138, 1, -10),
	...
	function section.new(page, title)
		local container = utility:Create("Frame", {
			...
			BorderSizePixel = 0,
			Position = UDim2.new(0.02, 0, 0.013, 0),
	...
	function library:addSpacer (...)
		local spacer = utility:Create("Frame", {
			...
			BackgroundTransparency = 1.000,
			BorderSizePixel = 0,
			Size = UDim2.new(1, -5, 0, ...),
		})
		return spacer
	end

	function library:addLabel (title)
